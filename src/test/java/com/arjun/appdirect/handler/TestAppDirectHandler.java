...
public class TestAppDirectHandler {
    ...
    @InjectMocks
    private AppDirectHandler handler;
    ...
    @Before
    public void setup() {
        this.handler = new AppDirectHandler(CONSUMER_KEY, CONSUMER_SECRET);
    ...
    public void testNoConsumerKeyThrowsException() {
        new AppDirectHandler(null, CONSUMER_SECRET);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testNoConsumerSecretThrowsException() {
        new AppDirectHandler(CONSUMER_KEY, null);
    }
    ...
    public void testSignUrl() throws OAuthCommunicationException, OAuthExpectationFailedException, OAuthMessageSignerException {
        ...
        String signedUrl = handler.signUrl(originalUrl);
